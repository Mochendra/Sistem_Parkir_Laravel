        ...
        <div class="card-panel white-text blue">
          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <!-- <a href="/user/edit/{{$usr->id}}"><button class="btn btn-secondary">Edit</button></a>
                            </td> -->
...
<div class="row">
 <div class="col s12">
 <h3>Petugas Pintu Masuk</h3> 
 <br/>
<a href="/menambah"><button class="btn waves-effect orange white-text">Tambah
Nomor</button></a> <br>            
 <div class="card-panel white-text blue">
 </br>
 <table>
 ...
 <!-- <td>
<a href="/user/delete/{{$usr->id}}" onclick="return confirm('Admin Yakin ingin 
menghapusnya?');"><button class="btn waves-effect red white-text">Hapus</button></a>
