  ...
  <div class="row">
    <div class="col s10">
      <div class="card-panel">
        ...
        <br>
        <br>
        <a href="/tambah"><button class="btn btn-primary">Tambah Data</button></a> <br>
        <div class="card-panel white-text blue">
          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                <a href="/users/delete/{{$usr->id}}" onclick="return confirm('Admin Yakin ingin menghapusnya?');">
                  <button class="btn btn-danger">Hapus</button></a>
                <a href="/users/edit/{{$usr->id}}"><button class="btn btn-secondary">Edit</button></a>
              </td>
              </td>
            </tr>
            @endforeach
